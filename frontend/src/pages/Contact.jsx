        ...
        <div className="w-[99vw] min-h-[100vh] flex items-center justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]">
            ...
            <div className="w-[100%] flex items-center justify-center flex-col lg:flex-row">
                <div className="lg:w-[50%] w-[100%] flex items-center justify-center">
                    <img src={contact} alt="" className="wlg:w-[70%] w-[80%]] shadow-md shadow-black"/>
                </div>
                <div className="lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]">
                    <p className="lg:w-[80%] w-[100%] text-[white] font-bold lg:text-[18px] text-[15px]">Our Store</p>
                    <p className="lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]">
                        <p>M-242 Control Station</p>
                        <p>Raghubir Nagar, New Delhi, India</p>
                    </p>
                    <p className="lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]">
                        <p>tel: +91-9582728636</p>
                        <p>Email: dimpleaggarwal192006@gmail.com</p>
                    </p>
                    <p className="lg:w-[80%] w-[100%] text-[white] lg:text-[18px] mt-[10px] font-bold">Carrers at MyCart</p>
