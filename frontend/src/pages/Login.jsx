            ...
            <div className="max-w-[600px] w-[90%] h-[500px] bg-[#0000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center">
                <form action="" onSubmit={handleLogin} className="w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px] ">
                    ...
                    <div className="relative w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]">
                        ...
                        <p className="flex gap-[10px]">Don't have an account?<span className="text-[17px] font-semibold text-[#5555f6cf] cursor-pointer" onClick={()=>navigate("/signup")}>Create New Account</span></p>
                    </div>
                </form>
            </div>
        </div>
