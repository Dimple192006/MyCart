...
//                 <h1 className="text-[35px] text-[#afe2f2]">MyCart Admin Panel</h1>
...
//                         Total No. of Products: <span className="px-[20px] py-[10px] bg-[#030e11] rounded-lg flex items-center justify-center border-[1px]">{totalProducts}</span>
//                     </div>
//                     <div className="text-[#dcfafd] w-[400px] max-w-[90%] h-[200px] bg-[#0000002e] flex items-center justify-center flex-col gap-[20px] rounded-lg shadow-sm shadow-black backdrop:blur-lg md:text-[25px] text-[20px] border-[1px] border-[#969595]">
//                         Total No. of Orders: <span className="px-[20px] py-[10px] bg-[#030e11] rounded-lg flex items-center justify-center border-[1px]">{totalOrders}</span>
//                     </div>
//                 </div>
//             </div>
//         </div>
            ...
            <div className="w-[70vw] h-[100vh] absolute left-[25%] flex items-start justify-start flex-col gap-[40px] py-[100px]">
                ...
                <div className="flex items-start justify-start gap-[50px] flex-col md:flex-row">
                    <div className="text-[#dcfafd] w-[400px] max-w-[90%] h-[200px] bg-[#0000002e] flex items-center justify-center flex-col gap-[20px] rounded-lg shadow-sm shadow-black backdrop:blur-lg md:text-[25px] text-[20px] border-[1px] border-[#969595]">
                        ...
                        <span className="px-[20px] py-[10px] bg-[#030e11] rounded-lg flex items-center justify-center border-[1px]">
                            {totalProducts}
                        </span>
                    </div>
