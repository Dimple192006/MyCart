...
function Lists(){
    ...
    const removeList=async(id)=>{
        try {
            ...
            if(result.data){
                ...
                console.log("Failes to Remove Product")
            }
        } catch (error) {
            console.log(error)
        }
    ...
    return(
        <div className="w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] overflow-hidden">
            ...
            <div className="w-[82%] h-[100%] lg:ml-[320px] md:ml-[230px] mt-[20px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[300px]">
