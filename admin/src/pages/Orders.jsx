...
function Orders(){
    ...
    const fetchAllProducts=async()=>{
        try {
            const result=await axios.post(serverUrl+"/api/orders/list",{},{withCredentials:true})
    ...
    const statusHandler=async(e,orderId)=>{
        try {
            const result=await axios.post(serverUrl+"/api/orders/status",{orderId,status:e.target.value},{withCredentials:true})
            if(result.data){
    ...
    return(
        <div className="w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white]">
            ...
            <div className="w-[100%] h-[100%] flex items-center lg:justify-start justify-center">
                <Sidebar/>
                <div className="lg:w-[855] md:w-[70%] h-[100%] lg:ml-[310px] md:ml-[250px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[100px]">
...

                    {
                        orders.map((order,index)=>(
                            <div key={index} className="w-[90%] h-[40%] bg-slate-600 rounded-xl flex lg:items-center items-start justify-between flex-col lg:flex-row p-[10px] md:px-[20px] gap-[20px]">
                                ...
                                <div>
                                    <div className="flex items-start justify-center flex-col gap-[5px] text-[16px] text-[#56db5c]">
                                        {
                                    ...
                                    <div className="text-[15px] text-green-1000">
                                ...
                                <div className="text-[15px] text-green-100">
                                    ...
                                    <p>Payment: {order.payment ? "Doone" : "Pending"}</p>
