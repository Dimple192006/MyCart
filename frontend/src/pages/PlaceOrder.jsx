    ...
    const onChangeHandler = (e)=>{
        ...
        const onSubmitHandler=async(e)=>{
            ...
            try {
                ...
                switch(method){
                    case "cod" :
                        const result=await axios.post(serverUrl+"/api/orders/placeorder",orderData,{withCredentials:true})
        ...
        <div className="w-[100vw] min-h-[100vh]  bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center flex-col md:flex-row gap-[50px] relative">
            <div className="lg:w-[50%] w-[100%] h-[100%] flex items-center justify-center lg:mt-[0px] mt-[90px] ">
                <form onSubmit={onSubmitHandler} action="" className="lg:w-[70%] w-[95%] lg:h-[70%] h-[100%]">
                    ...
                    <div >
                        <button type="submit" className="text-[18px] active:bg-slate-500 cursor-pointer bg-[#3bcee848]  py-[10px] px-[50px] rounded-2xl text-white flex items-center justify-center gap-[20px] absolute lg:right-[20%] bottom-[10%] right-[35%] border-[1px] border-[#808080449] ml-[30px] mt-[20px]">{loading ? <Loading/> : "PLACE ORDER" }</button>
                    </div>
                </form>
