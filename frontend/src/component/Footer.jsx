    ...
    return(
        <div className="w-[100%] md:h-[36vh] h-[21vh] mb-[77px] md:mb-[0px]">
            <div className="w-[100%] md:h-[30vh] h-15vh] md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px] ">
                <div className="md:w-[30%] w-[35%] h-[100%] justify-center flex-col gap-[5px]">
                    <div className="flex items-start justify-strt gap-[5px] mt[10px] md:mt-[40px]">
                        <img src={logo} alt="" className="md:w-[40px] md:h-[40px] w-[30px] h-[30px]"/>
                        <p className="text-[19px] md:text-[20px] text-[black]">MyCart</p>
                        
                    </div>
                    <p className="text-[15px] text-[#1e2223] hidden md:block">MyCart is your all-in-one Online Shoppping Destination, offering top-quality products, unbeatable deals, and fast delivery-all backed by trusted service designed to make your life easier every day.</p>
                    <p className="text-[15px] text-[#1e2223] flex md:hidden">Fast. Easy. Reliable. MyCart Shopping</p>
                ...
                <div className="md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center">
                    ...
                    <div className="md:w-[25%] w-[40%] h-[100%] flex items-center justify-center flex-col text-center">
                        ...
                        <ul>
                            <li className="text-[15px] text-[#1e2223] hidden md:block cursor-pointer">+91-9582728636</li>
                            <li className="text-[15px] text-[#1e2223] cursor-pointer">dimpleaggarwal192006@gmail.com</li>
                            <li className="text-[15px] text-[#1e2223] hidden md:block cursor-pointer">+1-123-456-7890</li>
                            <li className="text-[15px] text-[#1e2223] cursor-pointer">admin@mycart.com</li>
                        </ul>
                    </div>
            ...
            <div className="w-[100%] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center">Copyright 2025@mycar.com-All Rights Reserved</div>
        </div>
    )
}
